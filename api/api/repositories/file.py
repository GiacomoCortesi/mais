...
from api.models import FileResponse as File
...
class InMemoryFileRepository(FileRepository):
    ...
    def get_by_id(self, id: str) -> File:
...
class AWSFileStore(FileStore):
    ...
    def delete(self, filename: str) -> None:
        ...
        self._run_s3('delete_object', **kwargs)
    ...
    def delete_all(self) -> None:
        ...
        res = self._run_s3('list_objects_v2', **kwargs)
        for object in res['Contents']:
            kwargs = {
                'Bucket': self.bucket_name,
                'Key': object['Key']
            }
            res = self._run_s3('delete_object', **kwargs)
