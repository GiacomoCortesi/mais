...
import boto3
from openapi_server.domain.exceptions import FileNotFoundException, FileStoreException
...
class LocalFileStore(FileStore):
    ...
    def store(self, filename: str, content: IO[bytes]) -> str:
    ...
    def get_file(self, filename: str) -> IO[bytes]:
        return open(self._get_file_path(filename), 'rb')